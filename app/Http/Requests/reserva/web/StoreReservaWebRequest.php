...
class StoreReservaWebRequest extends FormRequest
{
    ...
    {
        return [
            // id_cliente NO se requiere - se toma del token automáticamente
            // id_estado_res y id_fuente se asignan automáticamente en el controller

...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('mantenimientos', function (Blueprint $table) {
            ...
            // índices
            $table->index('id_usuario_asigna', 'idx_mant_us_asigna');
            $table->index('id_usuario_reporta', 'idx_mant_us_reporta');
            $table->index('id_habitacion', 'idx_mant_habitacion');
            ...
            $table->foreign('id_habitacion', 'fk_mant_habitacion')
    ...
    {
        Schema::table('mantenimientos', function (Blueprint $table) {
            $table->dropForeign('fk_mant_us_asigna');
            $table->dropForeign('fk_mant_us_reporta');
            $table->dropForeign('fk_mant_habitacion');

            $table->dropIndex('idx_mant_us_asigna');
            $table->dropIndex('idx_mant_us_reporta');
            $table->dropIndex('idx_mant_habitacion');
